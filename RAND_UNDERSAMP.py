...
if False:  # Rodger z'n df downsize (heb ik nodig om deze code op mijn pc te runnen - TJ)
...
over = imb.over_sampling.RandomOverSampler(sampling_strategy=0.10, random_state=42)
